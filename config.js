...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~wBBA0IqI#yspZWAr5lmX4OqBv3xCdEggEOGAUhK9vgw9jBDbbZzU",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NAME: process.env.OWNER_NAME || "PRECIEUX",           // Owner's name
